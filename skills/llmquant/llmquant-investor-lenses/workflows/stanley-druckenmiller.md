...
\- \*\*No averaging into losing macro trades.\*\* A losing macro trad

[Content truncated — showing first 5,000 of 6,799 chars. LLM summarization timed out. To fix: increase auxiliary.web_extract.timeout in config.yaml, or use a faster auxiliary model. Use browser_navigate for the full page.]